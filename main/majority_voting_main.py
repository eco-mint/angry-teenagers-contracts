...
sp.add_compilation_target(Config.MAIN_MAJ_CONTRACT_NAME,
                          DAO.DaoMajorityVoting(
                              ...
                              current_dynamic_quorum_value_pertenmill=sp.nat(Config.MAIN_MAJ_DYNAMIC_INIT_VALUE_PERTENMILL),
...
sp.add_compilation_target(Config.OPTOUT_MAJ_CONTRACT_NAME,
                          DAO.DaoMajorityVoting(
                              admin=sp.address(Config.ADMINISTRATOR_ADDRESS),
                              current_dynamic_quorum_value_pertenmill=sp.nat(Config.OPTOUT_MAJ_DYNAMIC_INIT_VALUE_PERTENMILL),
